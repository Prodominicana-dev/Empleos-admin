    ...
    const handleSubmit = async (e) => {
        ...
        console.log(registro)
          ...
          // Realizar la solicitud HTTP POST utilizando Axios
           ...
           await Axios.post(`${Url}User`,registro).then(res=>{
            ...
            <div className="flex flex-column align-items-center justify-content-center">
                ...
                <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, var(--primary-color) 100%, rgba(33, 150, 243, 0) 30%)' }}>
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                        <label htmlFor="name" className="block text-900 text-xl font-medium mb-2 control-label required">
                                Nombre completo
                            </label>
                            <InputText inputid="name" type="text" placeholder="Nombre y Apellido" className="w-full md:w-30rem mb-3 " style={{ padding: '1rem' }} value={name} onChange={(e) => setName(e.target.value)} required />
                            ...
                            <InputText inputid="email1" type="text" placeholder="email" className="w-full md:w-30rem mb-3 " style={{ padding: '1rem' }} value={email} onChange={(e) => setEmail(e.target.value)} required />
