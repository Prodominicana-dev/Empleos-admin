...
const Aplicantes = (data) => {

     console.log(data)
    const {Id,NombreVacante} = data.data[0]
   ...
   console.log(data.data[0].Id)
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between ">
            <h5 className="m-0">Aplicantes a: {NombreVacante}.</h5>
